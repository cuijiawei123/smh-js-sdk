...
**contents** | [**Array&lt;CreateSearch200ResponseContentsInner&gt;**](CreateSearch200ResponseContentsInner.md) | 第一页搜索结果，可能为空数组，有关异步搜索的说明请参阅【接口说明】 | [optional] [default to undefined]

## Example

```typescript
import { CreateSearch200Response } from './api';

const instance: CreateSearch200Response = {
    searchId,
    searchFinished,
    hasMore,
    nextMarker,
